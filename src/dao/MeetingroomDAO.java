...
public class MeetingroomDAO {
	...
	//按会议室number查询
	 public Meetingroom selectBynum(String number){
		 ...
		 try {
			...
			String sql="select * from meetingroom where MeetingRoom_number='"+number+"'";
			...
			if(rs.next()==true){
				...
				//System.out.println("DAO_selectByNamePwd: "+ rs.getString("meetingroom_name"));
	...
	public void insert(Meetingroom meetingroom) {
		...
		String sql = "insert into meetingroom" + "(MeetingRoom_number,MeetingRoom_name,MeetingRoom_max,MeetingRoom_state,MeetingRoom_remark)" + " values(?,?,?,?,?)";
		try {
