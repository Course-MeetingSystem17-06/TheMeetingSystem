...
<body>
	<div class="page-content">
		...
		<form name="form1" action="UpdateMeetingRoomServlet?code=update&roomid=${requestScope.roomid}" method="post">
			<fieldset>
				<legend>会议室信息</legend>
				<tr>
					<td>提示信息:</td>
				...
				<table class="formtable" style="width: 50%">
					<tr>
						...
						<td><input id="roomnumber" name="roomnumber" type="text"
							...
							value="${requestScope.roomnumber}" /></td>
					</tr>
					<tr>
						<td>会议室名称:</td>
						<td><input id="roomname" name="roomname" type="text"
							placeholder="例如：第一会议室" maxlength="20"
							value="${requestScope.roomname}" /></td>
					</tr>
					<tr>
						<td>最多容纳人数：</td>
						<td><input id="roommax" name="roommax" type="text"
							placeholder="填写一个正整数" value="${requestScope.roommax}" /></td>
					</tr>
					<tr>
						<td>当前状态：</td>
						<td><label for="status"><input type="radio"
								id="roomstate_1" name="status" value="1" />启用 <input
								type="radio" id="roomstate_0" name="status" />停用 <input
								type="radio" id="roomstate_d" name="status" />删除</label></td>
					</tr>
					<tr>
						<td>备注：</td>
						<td><textarea id="roomremark" neme="roomremark"
							...
							value="${requestScope.roomremark}" /></td>
					</tr>
					<tr>
						<td colspan="2" class="command"><input type="submit"
							value="确认修改" class="clickbutton" /> <input type=button value="返回"
