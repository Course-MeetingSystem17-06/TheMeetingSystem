<%@ page language="java"
	import="java.util.*,vo.*" pageEncoding="utf-8"%>
		...
		$.ajax({
			...
			success : function(message) {
				...
				if (data.flag) {
					...
					validateMessage.html("<font name=error>"+data.msg+"</font>");
					validateMessage.css({
						color : "red"
					});
					document.getElementById('confirminfo').innerHTML=validateMessage.innerHTML;
				...
				<table class="formtable" style="width: 50%">
					<tr>
						...
						<td><input type="text" id="employeename" name="employeename"
							maxlength="20" value="${param.employeename}" onchange="checknull(this.value,this.id)"/>
					...
					<tr>
						...
						<td><input type="password" id="firstpassword" name="password"
							maxlength="20" placeholder="请输入6位以上的密码" onchange="checknull(this.value,this.id)">
					...
					<tr>
						<td colspan="6" class="command"><input type="submit"
							class="clickbutton" value="注册" id="register_button" disabled="disabled"/> <input type="reset"
